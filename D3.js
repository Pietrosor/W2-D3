...
console.log("I personaggi sono " + charactersNames)
...
} else if ((500 > crewMass, crewMass > 700)) {
  console.log("Ship is half loaded")
} else if ((700 > crewMass, crewMass > 900)) {
  console.log("Warning: Load is over 700")
} else if ((900 > crewMass, crewMass > 1000)) {
...
/* ESERCIZIO 8
    ...
    di alcuni personaggi dal valore "n/a" a "robot" (Tip: puoi effettuare
...
/* --EXTRA-- ESERCIZIO 10
    Crea una funzionalità che selezioni un elemento casuale dall'array
     "starWarsCharacters" e ne stampi in console le proprietà in modo discorsivo (a tuo piacimento).
  */
